import 'package:checkout_payment_ui/Features/checkout/data/repo/stripe_repo_implementation.dart';
...
import 'package:checkout_payment_ui/Features/checkout/presentation/views/widgets/payment_bottom_sheet.dart';
            ...
            onTap: () {
              ...
              showModalBottomSheet(
                  ...
                  builder: (context) {
                    return BlocProvider(
                      create: (context) =>
                          StripePaymentCubit(StripeRepoImplementation()),
